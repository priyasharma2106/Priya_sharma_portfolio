  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen text-center">
      ...
      <p className="mt-2 text-gray-500 dark:text-gray-400">Sorry, the page you are looking for does not exist.</p>
        <Link className="mt-5 flex items-center gap-1 hover:gap-3 rounded-full bg-gradient-to-r from-orange-500 to-orange-700 px-3 md:px-8 py-3 text-center text-xs md:text-sm font-medium uppercase tracking-wider text-white no-underline transition-all duration-200 ease-out hover:text-white hover:no-underline md:font-semibold hover:from-orange-400 hover:to-orange-600 hover:shadow-[0_0_15px_rgba(249,115,22,0.4)]"
        role="button" 
        href="/"
      >
        Go to Home
