...
function ProjectCard({ project }) {
  ...
  return (
  <div className="from-[#0a0a0a] border-[#2a2a2a80] relative rounded-lg border bg-gradient-to-r to-[#111111] w-full">
      <div className="flex flex-row">
  <div className="h-[1px] w-full bg-gradient-to-r from-transparent via-orange-500 to-transparent"></div>
  ...
  <p className="text-center ml-3 text-orange-400 text-base lg:text-xl">
          {project.name}
        </p>
      </div>
